...
public class calenderbarbara extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_calender_barbara);

        // Find the TextView view in your layout
        TextView textView = findViewById(R.id.calender2);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(calenderbarbara.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        Button backButton = findViewById(R.id.back_calender_barbara);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(calenderbarbara.this, John.class);
        ...
        Button bookButton = findViewById(R.id.book2);
        ...
        bookButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(calenderbarbara.this, Confirmation.class);
                startActivity(intent);
            }
        });
    }
